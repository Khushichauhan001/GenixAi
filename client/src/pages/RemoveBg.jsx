import { Edit, Eraser, Hash, Image, Sparkle } from 'lucide-react'
            ...
            const onSubmitHandler = async(e) =>{
                 ...
                 try {
                   ...
                   if(data.success ){
                    ...
                    toast.error(data.message || 'Could not remove background. Please try again later.')
                   }
                 } catch (error) {
                   toast.error(error.message || 'Could not remove background. Please try again later.');
                 }
                   setLoading(false);
            }
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
        <div className='flex items-center gap-3'>
          <Eraser className='w-5 h-5 text-[#FFA938]'/>
